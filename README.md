...
## ✅ Лабораторная работа № 2  
  ...
  💟Работа над проектом выполненяется в составе команды "Бивис и Баттхед".💟    
...
Репозиторий командного проекта доступен по ссылке:  <a href=https://github.com/S7yka4/IT_Project> IT_Project  </a>  
