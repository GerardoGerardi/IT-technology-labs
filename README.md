...
В целом, работу протокола можно описать следующим образом:
   ...
   2. Маршрутизатор представляет общий доступ к сообщениям маршрутизации и данным об маршрутах для других маршрутизаторов, использующих тот же протокол маршрутизации.    3. Маршрутизаторы осуществляют обмен данными маршрутизации для получения информации об удалённых сетях  
